  ...
  const PLATFORM_THEMES = [
    ...
    { id:'red',        name:'Red',        hex:'#cf6b5c' },
    { id:'rose',       name:'Rose',       hex:'#cc7480' },
    { id:'pink',       name:'Pink',       hex:'#d98a9c' },
    { id:'fuchsia',    name:'Fuchsia',    hex:'#b87aa0' },
    { id:'purple',     name:'Purple',     hex:'#9678c2' },
    { id:'violet',     name:'Violet',     hex:'#8a7bd6' },
    { id:'indigo',     name:'Indigo',     hex:'#7b83c9' },
    { id:'blue',       name:'Blue',       hex:'#6690c9' },
    { id:'sky',        name:'Sky',        hex:'#71a8cf' },
    { id:'cyan',       name:'Cyan',       hex:'#5fb0b0' },
    { id:'teal',       name:'Teal',       hex:'#4f9a8d' },
    { id:'emerald',    name:'Emerald',    hex:'#5c9f7f' },
    { id:'green',      name:'Green',      hex:'#6fa76f' },
    { id:'lime',       name:'Lime',       hex:'#9aad55' },
    { id:'yellow',     name:'Yellow',     hex:'#cba64c' },
    { id:'amber',      name:'Amber',      hex:'#cf9752' },
    { id:'terracotta', name:'Terracotta', hex:'#bd7a52' },
    { id:'brown',      name:'Brown',      hex:'#9c7a5a' },
    { id:'maroon',     name:'Maroon',     hex:'#a35a6a' },
    { id:'slate',      name:'Slate',      hex:'#7a8ba3' },
    { id:'gray',       name:'Gray',       hex:'#8f8778' }
  ];
