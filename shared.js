...
// Do not add type="module" or defer/async to its <script> tag -- execution order matters.
  ...
  const T = {
    en: {
      ...
      autofillNote:'✓ Your saved address has been auto-filled', township:'🏢 Township', society:'🏘️ Society', societyOther:'📍 Other — type your address', societyOtherPh:'Building / area name', errSocietyOther:'Please type your building or area.', flat:'🏠 Flat Number',
    ...
    hinglish: {
      ...
      autofillNote:'✓ Aapka saved address auto-fill ho gaya', township:'🏢 Township', society:'🏘️ Society', societyOther:'📍 Other — apna address likhein', societyOtherPh:'Building / area ka naam', errSocietyOther:'Kripya apni building ya area likhein.', flat:'🏠 Flat Number',
    ...
    hi: {
      ...
      autofillNote:'✓ आपका सेव किया पता अपने-आप भर गया', township:'🏢 टाउनशिप', society:'🏘️ सोसायटी', societyOther:'📍 अन्य — अपना पता लिखें', societyOtherPh:'बिल्डिंग / एरिया का नाम', errSocietyOther:'कृपया अपनी बिल्डिंग या एरिया लिखें।', flat:'🏠 फ़्लैट नंबर',
    ...
    gu: {
      ...
      autofillNote:'✓ તમારું સાચવેલ સરનામું ઓટો-ફિલ થયું', township:'🏢 ટાઉનશિપ', society:'🏘️ સોસાયટી', societyOther:'📍 અન્ય — તમારું સરનામું લખો', societyOtherPh:'બિલ્ડિંગ / વિસ્તારનું નામ', errSocietyOther:'કૃપા કરીને તમારી બિલ્ડિંગ અથવા વિસ્તાર લખો.', flat:'🏠 ફ્લેટ નંબર',
